...
void loop()
{
	...
	SwitchLivolo(1);
	delay(1000);
	state1 = digitalRead(RusState1Pin);
	if (state1 == HIGH)
	{
		Serial.println("CORRECT_1");
	}
	else
	{
		Serial.println("false_1");
	}
	delay(2000);
	SwitchLivolo(1);
	delay(1000);
	SwitchLivolo(2);
	delay(1000);
	state2 = digitalRead(RusState2Pin);
	if (state2 == HIGH)
	{
		Serial.println("CORRECT_2");
	}
	else
	{
		Serial.println("false_2");
	}
	delay(2000);
	SwitchLivolo(2);